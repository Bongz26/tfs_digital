...
export const createPurchaseOrder = async (poData) => {
  try {
    const res = await http.post(BASE_URL, poData);
...
export const addPOItem = async (poId, itemData) => {
  try {
    const res = await http.post(`${BASE_URL}/${poId}/items`, itemData);
...
export const processPurchaseOrder = async (poId, adminEmail) => {
  try {
    const res = await http.post(`${BASE_URL}/${poId}/process`, { admin_email: adminEmail });
    return res.data;
  } catch (err) {
...
export const receiveGRV = async (poId, receivedItems, receivedBy) => {
  try {
    const res = await http.post(`${BASE_URL}/${poId}/receive`, {
...
export const fetchSuppliers = async () => {
  try {
    const res = await http.get(`${BASE_URL}/suppliers`);
...
export const fetchSupplierItems = async (supplierId) => {
  try {
    const res = await http.get(`${BASE_URL}/suppliers/${supplierId}/items`);
    return res.data;
  } catch (err) {
...
export const deletePurchaseOrder = async (poId) => {
  try {
    const res = await http.delete(`${BASE_URL}/${poId}`);
    return res.data;
  } catch (err) {
...
export const updatePurchaseOrder = async (poId, poData) => {
  try {
    const res = await http.put(`${BASE_URL}/${poId}`, poData);
