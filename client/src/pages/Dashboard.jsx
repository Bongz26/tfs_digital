...
export default function Dashboard() {
  ...
  if (loading) return <div className="p-8 text-center text-red-600">Loading Live Data...</div>;
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
      <div className="text-center mb-10">
        ...
        <p className="text-yellow-600 text-xl font-semibold">Live from QwaQwa • Re tšotella lechaba la rona</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-yellow-500">
          ...
          <p className="text-5xl font-bold text-yellow-600 mt-2">{stats.lowStock.length}</p>
        </div>
